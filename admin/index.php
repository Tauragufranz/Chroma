...
<head>
  ...
  <title>Beranda - Chroma shopping</title>
...
<body>
  ...
  <div class="p-4 bg-white rounded shadow-sm text-center">
    <h2 class="mb-2">Selamat datang di website admin <strong>Chroma</strong></h2>
    <p class="text-muted">Kelola produk, transaksi, dan pelanggan dengan mudah</p>
  </div>
</div>
    ...
    <div class="card-body">
      ...
      <div class="d-flex align-items-center">
        <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
          <i class="bi bi-bag-check"></i> <!-- Ganti ikon kalau mau -->
        </div>
        <div class="ps-3">
          <h6>145</h6>
...
<div class="col-xxl-4 col-md-6">
  <div class="card info-card revenue-card">
    ...
    <div class="card-body">
      ...
      <div class="d-flex align-items-center">
        <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
          <i class="bi bi-cash-stack"></i> <!-- Ganti ikon kalau mau -->
        </div>
        <div class="ps-3">
          <h6>Rp3.264.000</h6>
